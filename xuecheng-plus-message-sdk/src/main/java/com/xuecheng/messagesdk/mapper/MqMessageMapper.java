...
public interface MqMessageMapper extends BaseMapper<MqMessage> {
    ...
    List<MqMessage> selectListByShardIndex(@Param("shardTotal") int shardTotal, @Param("shardIndex") int shardIndex,
                                           @Param("messageType") String messageType, @Param("count") int count);
