...
public class Mp4VideoUtil extends VideoUtil {
    // ffmpeg的安装位置
    public static final String FFMPEG_PATH = "D:\\CSLearning\\project\\xucheng-plus\\resoures\\ffmpeg\\bin\\ffmpeg.exe";
    String videoPath = "D:\\CSLearning\\project\\xucheng-plus\\resoures\\media-test\\video";
    String mp4Name = "test1.mp4";
    String mp4folderPath = "D:\\CSLearning\\project\\xucheng-plus\\resoures\\media-test\\video\\mp4";
...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        // ffmpeg的路径
        String ffmpeg_path = "D:\\CSLearning\\project\\xucheng-plus\\resoures\\ffmpeg\\bin\\ffmpeg.exe";// ffmpeg的安装位置
        // 源avi视频的路径
        String video_path = "D:\\CSLearning\\project\\xucheng-plus\\resoures\\media-test\\video\\test01.avi";
        // 转换后mp4文件的名称
        String mp4_name = "test_mp4.mp4";
        // 转换后mp4文件的路径
        String mp4_path = "D:\\CSLearning\\project\\xucheng-plus\\resoures\\media-test\\video\\mp4\\test_mp4.mp4";
        // 创建工具类对象
